...
const {getPath, setPathPrefix, addSuffix} = require('../../utils');
    ...
    return {
        ...
        ImportDeclaration(path) {
            ...
            !isExcludeSource(source.value) && specifiers && specifiers.forEach((sf) => {
                ...
                const desFilePath = addSuffix(setPathPrefix(getPath(curFileName, source.value)));
        ...
        Import(path) { // component: () => Import('.../AAA.jsx');
            ...
            sources.forEach(sr => {
                desFilePath = getPath(curFileName, sr.value);
