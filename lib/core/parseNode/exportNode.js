...
module.exports = function(nodeObj = {}, curFileName, rootContainer = {}, defaultSettings) {
    ...
    return {
        ExportNamedDeclaration(path) {
            ...
            if (!declaration) {
                ...
                if (source) { // ImportedToExportingFilePath
                    ...
                    const exportImportedFilePath = getPath(curFileName, source.value, defaultSettings);
        ...
        ExportAllDeclaration(path) {
            const exportImportedFilePath = getPath(curFileName, path.node.source.value, defaultSettings);
            rootContainer[curFileName] = rootContainer[curFileName] || {};
